      ...
      <nav className="sticky top-0 z-50 w-full bg-white/70 backdrop-blur-md border-b border-slate-200/50 shadow-[0_2px_20px_-4px_rgba(0,0,0,0.03)] transform-gpu">
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            ...
            >
              {user && (
                <div className="flex items-center gap-3 px-2 py-2 mb-2 bg-slate-50 border border-slate-100 rounded-2xl">
                  <Avatar size="sm" className="w-9 h-9 ring-2 ring-red-500/10">
                    <Avatar.Image
                      alt={user?.image || ""}
                      src={user?.image || ""}
                    />
              ...
              {user ? (
                <div className="space-y-2">
                  ...
                  <button
                    onClick={handleLogoutClick}
                    className="w-full cursor-pointer flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold text-slate-600 hover:bg-red-50 hover:text-red-600 transition-all text-left"
                  >
        ...
        {showModal && (
          <div className="fixed inset-0 z-99999 flex items-center justify-center p-4 transform-gpu">
            ...
            <motion.div
              ...
              className="relative bg-white rounded-3xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] border border-slate-200/80 p-6 w-full max-w-sm z-50 text-slate-700"
            >
